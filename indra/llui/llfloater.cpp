                                ...
                                F32 contex_cone_out_alpha)
{
        ...
        && gFocusMgr.childHasKeyboardFocus(this))
    {
        ...
        {
            LLRender::instance().color4f(0.f, 0.f, 0.f, contex_cone_in_alpha * context_cone_opacity);
            LLRender::instance().vertex2i(owner_rect.mLeft, owner_rect.mTop);
            LLRender::instance().color4f(0.f, 0.f, 0.f, contex_cone_out_alpha * context_cone_opacity);
            LLRender::instance().vertex2i(local_rect.mLeft, local_rect.mTop);
            LLRender::instance().color4f(0.f, 0.f, 0.f, contex_cone_in_alpha * context_cone_opacity);
            LLRender::instance().vertex2i(owner_rect.mRight, owner_rect.mTop);
            LLRender::instance().color4f(0.f, 0.f, 0.f, contex_cone_out_alpha * context_cone_opacity);
            LLRender::instance().vertex2i(local_rect.mRight, local_rect.mTop);
            LLRender::instance().color4f(0.f, 0.f, 0.f, contex_cone_in_alpha * context_cone_opacity);
            LLRender::instance().vertex2i(owner_rect.mRight, owner_rect.mBottom);
            LLRender::instance().color4f(0.f, 0.f, 0.f, contex_cone_out_alpha * context_cone_opacity);
            LLRender::instance().vertex2i(local_rect.mRight, local_rect.mBottom);
            LLRender::instance().color4f(0.f, 0.f, 0.f, contex_cone_in_alpha * context_cone_opacity);
            LLRender::instance().vertex2i(owner_rect.mLeft, owner_rect.mBottom);
            LLRender::instance().color4f(0.f, 0.f, 0.f, contex_cone_out_alpha * context_cone_opacity);
            LLRender::instance().vertex2i(local_rect.mLeft, local_rect.mBottom);
            LLRender::instance().color4f(0.f, 0.f, 0.f, contex_cone_in_alpha * context_cone_opacity);
            LLRender::instance().vertex2i(owner_rect.mLeft, owner_rect.mTop);
            LLRender::instance().color4f(0.f, 0.f, 0.f, contex_cone_out_alpha * context_cone_opacity);
            LLRender::instance().vertex2i(local_rect.mLeft, local_rect.mTop);
